...
namespace Clinic_Management_System.Models
{
    public partial class CMSContext : DbContext
    {
        ...
        public virtual DbSet<TestReportNew> TestReportNew { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        */
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TestReportNew>(entity =>
            {
                entity.HasKey(e => e.ReportId)
                    .HasName("PK__test_rep__779B7C584CCAD470");

                entity.ToTable("test_report_new");
                ...
                entity.HasOne(d => d.Patient)
                    .WithMany(p => p.TestReportNew)
                    .HasForeignKey(d => d.PatientId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__test_repo__patie__29221CFB");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.TestReportNew)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__test_repo__staff__2A164134");
            });
