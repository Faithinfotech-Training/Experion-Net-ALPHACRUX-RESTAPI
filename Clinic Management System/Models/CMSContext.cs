...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source= ARSHINJOSE\\SQLEXPRESS; Initial Catalog= CMS; Integrated security=True");
            }
        }
        */
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Authentications>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__authenti__B9BE370F7EC364DD");
                ...
                entity.HasOne(d => d.Staff)
                    ...
                    .HasConstraintName("FK__authentic__staff__5165187F");
            });

            modelBuilder.Entity<ConsultationBills>(entity =>
            {
                entity.HasKey(e => e.ConsultationBillId)
                    .HasName("PK__consulta__DD3FD667D09C84C1");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasConstraintName("FK__consultat__patie__5535A963");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.ConsultationBills)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__consultat__staff__5629CD9C");
            });

            modelBuilder.Entity<Departments>(entity =>
            {
                entity.HasKey(e => e.DepartmentId)
                    .HasName("PK__departme__C22324224D19B7FF");
            ...
            modelBuilder.Entity<DoctorNote>(entity =>
            {
                entity.HasKey(e => e.NoteId)
                    .HasName("PK__doctor_n__6B7594EC5628E61F");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__doctor_no__patie__0A9D95DB");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.DoctorNote)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__doctor_no__staff__0B91BA14");
            });

            modelBuilder.Entity<LabBills>(entity =>
            {
                entity.HasKey(e => e.LabBillId)
                    .HasName("PK__lab_bill__F353DA8E8CD5289C");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__lab_bills__patie__72C60C4A");

                entity.HasOne(d => d.TestList)
                    .WithMany(p => p.LabBills)
                    .HasForeignKey(d => d.TestListId)
                    .HasConstraintName("FK__lab_bills__test___71D1E811");
            });

            modelBuilder.Entity<Manufactures>(entity =>
            {
                entity.HasKey(e => e.ManufactureId)
                    .HasName("PK__manufact__1F2B08C37B97AB33");
            ...
            modelBuilder.Entity<MedicalHistory>(entity =>
            {
                entity.HasKey(e => e.MedicalListId)
                    .HasName("PK__medical___4CECA9C710788C3D");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__medical_h__patie__05D8E0BE");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.MedicalHistory)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__medical_h__staff__06CD04F7");
            });

            modelBuilder.Entity<MedicineBills>(entity =>
            {
                entity.HasKey(e => e.MedicineBillId)
                    .HasName("PK__medicine__B47E7D0FB8AC8DB2");
                ...
                entity.HasOne(d => d.Inventory)
                    ...
                    .HasConstraintName("FK__medicine___inven__7D439ABD");

                entity.HasOne(d => d.Patient)
                    .WithMany(p => p.MedicineBills)
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__medicine___patie__7C4F7684");

                entity.HasOne(d => d.Prescription)
                    .WithMany(p => p.MedicineBills)
                    .HasForeignKey(d => d.PrescriptionId)
                    .HasConstraintName("FK__medicine___presc__7E37BEF6");
            });

            modelBuilder.Entity<MedicineDetails>(entity =>
            {
                entity.HasKey(e => e.MedicineId)
                    .HasName("PK__medicine__E7148EBB70F45039");
            ...
            modelBuilder.Entity<MedicineInventories>(entity =>
            {
                entity.HasKey(e => e.InventoryId)
                    .HasName("PK__medicine__B59ACC49CA2FF392");
                ...
                entity.HasOne(d => d.Manufacture)
                    ...
                    .HasConstraintName("FK__medicine___manuf__787EE5A0");

                entity.HasOne(d => d.Medicine)
                    .WithMany(p => p.MedicineInventories)
                    .HasForeignKey(d => d.MedicineId)
                    .HasConstraintName("FK__medicine___medic__778AC167");
            });

            modelBuilder.Entity<MedicineLists>(entity =>
            {
                entity.HasKey(e => e.MedicineListId)
                    .HasName("PK__medicine__43D1547C802E6E22");
                ...
                entity.HasOne(d => d.Medicine)
                    ...
                    .HasForeignKey(d => d.MedicineId)
                    .HasConstraintName("FK__medicine___medic__01142BA1");

                entity.HasOne(d => d.Prescription)
                    .WithMany(p => p.MedicineLists)
                    .HasForeignKey(d => d.PrescriptionId)
                    .HasConstraintName("FK__medicine___presc__02084FDA");
            });

            modelBuilder.Entity<Patients>(entity =>
            {
                entity.HasKey(e => e.PatientId)
                    .HasName("PK__patients__4D5CE476C79B206F");
            ...
            modelBuilder.Entity<Payments>(entity =>
            {
                entity.HasKey(e => e.PaymentId)
                    .HasName("PK__payments__ED1FC9EA72B7CAA3");
            ...
            modelBuilder.Entity<PrescribedMedicines>(entity =>
            {
                entity.HasKey(e => e.PrescriptionId)
                    .HasName("PK__prescrib__3EE444F826E852F4");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__prescribe__patie__5EBF139D");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.PrescribedMedicines)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__prescribe__staff__5FB337D6");
            });

            modelBuilder.Entity<Qualifications>(entity =>
            {
                entity.HasKey(e => e.QualificationId)
                    .HasName("PK__qualific__CDACC5DBECFB1D35");
            ...
            modelBuilder.Entity<Roles>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__roles__760965CC2A09742A");
            ...
            modelBuilder.Entity<Staffs>(entity =>
            {
                entity.HasKey(e => e.StaffId)
                    .HasName("PK__staffs__1963DD9CE1EEB748");
                ...
                entity.HasOne(d => d.Department)
                    ...
                    .HasConstraintName("FK__staffs__departme__4E88ABD4");

                entity.HasOne(d => d.Qualification)
                    .WithMany(p => p.Staffs)
                    .HasForeignKey(d => d.QualificationId)
                    .HasConstraintName("FK__staffs__qualific__4D94879B");

                entity.HasOne(d => d.Role)
                    .WithMany(p => p.Staffs)
                    .HasForeignKey(d => d.RoleId)
                    .HasConstraintName("FK__staffs__role_id__4CA06362");
            });

            modelBuilder.Entity<TestAdvices>(entity =>
            {
                entity.HasKey(e => e.AdviceId)
                    .HasName("PK__test_adv__A2B9EF6A17001F84");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__test_advi__patie__693CA210");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.TestAdvices)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__test_advi__staff__6A30C649");
            });

            modelBuilder.Entity<TestDetails>(entity =>
            {
                entity.HasKey(e => e.TestId)
                    .HasName("PK__test_det__F3FF1C0291C10F8B");
            ...
            modelBuilder.Entity<TestLists>(entity =>
            {
                entity.HasKey(e => e.TestListId)
                    .HasName("PK__test_lis__932FE13086784BF4");
                ...
                entity.HasOne(d => d.Advice)
                    ...
                    .HasConstraintName("FK__test_list__advic__6D0D32F4");

                entity.HasOne(d => d.Test)
                    .WithMany(p => p.TestLists)
                    .HasForeignKey(d => d.TestId)
                    .HasConstraintName("FK__test_list__test___6E01572D");
            });

            modelBuilder.Entity<TestReports>(entity =>
            {
                entity.HasKey(e => e.ReportId)
                    .HasName("PK__test_rep__779B7C58918A2632");
                ...
                entity.HasOne(d => d.Patient)
                    ...
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__test_repo__patie__6383C8BA");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.TestReports)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__test_repo__staff__6477ECF3");

                entity.HasOne(d => d.Test)
                    .WithMany(p => p.TestReports)
                    .HasForeignKey(d => d.TestId)
                    .HasConstraintName("FK__test_repo__test___656C112C");
            });

            modelBuilder.Entity<Tokens>(entity =>
            {
                entity.HasKey(e => e.TokenId)
                    .HasName("PK__tokens__CB3C9E172348CABD");
                ...
                entity.HasOne(d => d.Patient)
                    .WithMany(p => p.Tokens)
                    .HasForeignKey(d => d.PatientId)
                    .HasConstraintName("FK__tokens__patient___59FA5E80");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.Tokens)
                    .HasForeignKey(d => d.StaffId)
                    .HasConstraintName("FK__tokens__staff_id__5AEE82B9");
            });

            modelBuilder.Entity<Units>(entity =>
            {
                entity.HasKey(e => e.UnitId)
                    .HasName("PK__units__D3AF5BD7A8028A50");
            ...
            modelBuilder.Entity<Vitals>(entity =>
            {
                entity.HasKey(e => e.VitalId)
                    .HasName("PK__vitals__4DF3C471A9D56155");
